...
## Deployment
The trufflehog chart can be deployed via helm:

```bash
# Install HelmChart (use -n to configure another namespace)
helm upgrade --install trufflehog secureCodeBox/trufflehog
```
...
| parser.image.repository | string | `"docker.io/securecodebox/scanner-trufflehog"` | Parser image repository |
...
| scanner.image.repository | string | `"docker.io/securecodebox/scanner-trufflehog"` | Container Image to run the scan |
